...
public class QualityRecyclerAdapter extends RecyclerView.Adapter<QualityRecyclerAdapter.MyViewHolder> {
    Context context;
    List<String> image_urls;
    private AsyncImageLoader imageLoader;//异步组件
    private QualityItemOnClickListener qualityItemOnClickListener;

    public QualityRecyclerAdapter(Context context, List<String> image_urls) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                context).inflate(R.layout.item_mai_quality, parent,
                false),qualityItemOnClickListener);
        return holder;
    }
    ...
    class MyViewHolder extends ViewHolder implements View.OnClickListener {
        ...
        private QualityItemOnClickListener itemOnClickListener;
        public MyViewHolder(View view,QualityItemOnClickListener itemOnClickListener) {
            super(view);
            mai_quality_image = (ImageView) view.findViewById(R.id.mai_quality_image);
    ...
    public interface QualityItemOnClickListener{
        void itemClick(View view, int position);
    }
    public void setQualityItemOnClickListener(QualityItemOnClickListener qualityItemOnClickListener){
        this.qualityItemOnClickListener = qualityItemOnClickListener;
    }
}
